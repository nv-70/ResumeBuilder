...
export const ResumeSummaryCard = ({
  ...
  // generate design color based on title length
  ...
  return (
    <div
      ...
      onClick={onSelect}
      onMouseEnter={() => setIsHovered(true)} // mouse or swipe for mobile views
    ...
    >
      {thumbnailImg ? (
        <div className=" relative w-full h-full overflow-hidden">
          ...
          {/*Hover effect */}
          <div
            className="absolute inset-0 bg-gradient-to-t from-violet-100/30 t0-transparent opacity-0 
