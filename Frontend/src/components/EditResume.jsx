...
import { Download, Palette, Save, Trash2 } from "lucide-react";
...
} from "./Forms"; // Import all form components
...
const EditResume = () => {
  ...
  // take back to previous step or take to first or to /dashboard
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
  ...
  // remove item from array state using index
  ...
  // also saves the resume as the image
  ...
  // this function will help in updating the resumes. and put will help in updation in backend
...
// type of how it willlook when downloaded
    try {
      await html2pdf()
        .set({
          margin: 0,
        ...
        .from(element)
        .save(); // we will save the resumme here and then we download it...
      ...
      <Modal
        ...
        actionBtnIcon={
          isDownloading ? (
            ...
            <Check size={16} className="tex-white" />
          ) : (
            <Download size={16} />
          )
        }
