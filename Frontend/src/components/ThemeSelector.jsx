...
bg-gradient-to-r from-violet-600 to-fuchia-600 text-white font-black rounded-2xl hover:scale-105 transition-all 
            ...
            {resumeTemplates.map((template, index) => (
              <TemplateCard
                ...
                onselect={() => {
                  ...
                  setSelectedTheme(template.id); // live update in parent
                }}
              />
            ))}
          </div>
