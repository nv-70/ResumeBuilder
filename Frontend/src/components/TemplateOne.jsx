...
import { formatDuration } from "../utils/helper"; // ✅ use safe helper
              ...
              <div className="space-y-6">
                {workExperience.map((exp, i) => (
                  <WorkExperience
                    ...
                    company={exp.company}
                    role={exp.role}
                    duration={formatDuration(exp.startDate, exp.endDate)} // ✅ safe format
              ...
              <div className="space-y-4 pb-2">
                {education.map((edu, i) => (
                  <EducationInfo
                    ...
                    duration={formatDuration(edu.startDate, edu.endDate)} // ✅ safe format
                  />
                ))}
                <br />
              </div>
